...
const Contenido = ({solicitudes, certificados, setSolicitudes}) => {
    ...
    return (
      <div className='row row-cols-1 row-cols-md-3 text-center p-3'>
        ...
        {solicitudes && (solicitudes.map((item, index)=> (<Tarjeta key={index} elemento = {item} solicitudes={solicitudes} setSolicitudes={setSolicitudes}></Tarjeta>)))}
